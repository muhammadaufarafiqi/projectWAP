...
SVC_NAME="actions.runner.muhammadaufarafiqi-projectWAP.LAPTOP-UIEU9Q4T.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (muhammadaufarafiqi-projectWAP.LAPTOP-UIEU9Q4T)"
